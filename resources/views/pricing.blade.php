        ...
        <div class="overflow-hidden">
                    ...
                    <div class="relative md:flex md:items-center md:justify-between">
                        <div class="flex items-center justify-between">
                            <a class="flex-none focus:outline-hidden focus:opacity-80" href="#">
                                <svg class="w-28 h-auto" width="116" height="32" viewBox="0 0 116 32"
                                    ...
                                    <path
                                        ...
                                        class="stroke-violet-600 dark:stroke-white" stroke="currentColor"
                                        stroke-width="2" />
                                    <path
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <button id="hs-mega-menu-pdp" type="button"
                                            ...
                                            Resources
                                            <svg class="ms-2 size-2.5 text-gray-500 dark:text-neutral-500"
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-full hidden z-10 top-full start-0 min-w-60 bg-white md:shadow-2xl rounded-lg py-2 md:p-4 dark:bg-neutral-900 dark:divide-neutral-700 before:absolute before:-top-5 before:start-0 before:w-full before:h-5"
                                            role="menu" aria-orientation="vertical"
                                            aria-labelledby="hs-mega-menu-pdp">
                                            <div class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                <div class="flex flex-col mx-1 md:mx-0">
                                                    <a class="group flex gap-x-5 text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                                        href="#">
                                                        <svg class="shrink-0 size-5 mt-1"
                                                ...
                                                <div class="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                                                    ...
                                                    <a class="mt-4 group flex gap-x-5 items-center focus:outline-hidden"
                                                        href="#">
                                                        <img class="size-32 rounded-lg"
                                                            ...
                                                            alt="Avatar">
                                                        <div class="grow">
                                                            <p class="text-gray-800 dark:text-neutral-200">Preline
                                                                Projects has proved to be most efficient cloud based
                                                                project tracking and bug tracking tool.</p>
                                                            <p
                                    ...
                                    <div class="pt-3 md:pt-0">
                                        <a class="py-2.5 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-violet-900 text-white hover:bg-violet-700 focus:outline-hidden focus:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
                                            href="#">
                                            Request demo
                                        </a>
                                    </div>
            ...
            <div class="relative">
                ...
                <div aria-hidden="true" class="flex -z-1 absolute -top-48 start-0">
                    <div class="bg-purple-200 opacity-30 blur-3xl w-[1036px] h-150 dark:bg-purple-900 dark:opacity-20">
                    </div>
                    <div
                ...
                <div class="max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 lg:pt-14 mx-auto">
                    ...
                    <div class="flex justify-center items-center gap-x-3">
                        <label for="pricing-switch"
                            class="text-sm text-gray-800 dark:text-neutral-200">Monthly</label>
                        <label for="pricing-switch" class="relative inline-block w-11 h-6 cursor-pointer">
                            ...
                            <span
                                class="absolute inset-0 bg-gray-200 rounded-full transition-colors duration-200 ease-in-out peer-checked:bg-purple-600 dark:bg-neutral-700 dark:peer-checked:bg-purple-500 peer-disabled:opacity-50 peer-disabled:pointer-events-none"></span>
                            <span
                        ...
                        <label for="pricing-switch"
                            class="text-sm text-gray-800 dark:text-neutral-200">Annually</label>
                    </div>
                    <!-- End Switch -->

                    <!-- Grid -->
                    <div
                        class="mt-6 md:mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-1 md:gap-6 lg:gap-3 xl:gap-6 lg:items-center">
                        <!-- Card -->
                        ...
                        <div
                            ...
                            <p class="mb-3"><span
                                    ...
                                    popular</span></p>
                            <h4 class="font-medium text-lg text-gray-800 dark:text-neutral-200">Monthly </h4>
                            <span
                            ...
                            <a class="mt-5 py-3 px-4 w-full inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-violet-600 text-white hover:bg-violet-700 focus:outline-hidden focus:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
                                href="{{ route('checkout', ['plan' => 'price_1SLfC9LsxN8FK3AScHzm4Vdb']) }}">
                                Sign UP
                            </a>
                        </div>
                        <!-- End Card -->
                        ...
                        <div
                            ...
                            <h4 class="font-medium text-lg text-gray-800 dark:text-neutral-200">6 Months </h4>
                            <span
                                class="mt-5 font-bold text-3xl md:text-4xl xl:text-5xl text-gray-800 dark:text-neutral-200">
                                AED 270
                            </span>
                            ...
                            <a class="mt-5 py-3 px-4 w-full inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-violet-600 text-violet-600 hover:border-violet-500 hover:text-violet-500 focus:outline-hidden focus:border-violet-500 focus:text-violet-500 disabled:opacity-50 disabled:pointer-events-none dark:border-violet-500 dark:text-violet-500 dark:hover:text-violet-400 dark:hover:border-violet-400 dark:focus:text-violet-400 dark:focus:border-violet-400"
                                href="{{ route('checkout', ['plan' => 'price_1SLfDLLsxN8FK3ASGtIBpviD']) }}">
                                Sign UP
                            </a>
                        </div>
                        <!-- End Card -->
                        ...
                        <div
                            class="flex flex-col bg-white border border-gray-200 text-center rounded-2xl p-4 md:p-8 dark:bg-neutral-900 dark:border-neutral-800">
                            <h4 class="font-medium text-lg text-gray-800 dark:text-neutral-200">Yearly</h4>
                            <span
                                class="mt-5 font-bold text-3xl md:text-4xl xl:text-5xl text-gray-800 dark:text-neutral-200">
                                AED 500
                            </span>
                            ...
                            <a class="mt-5 py-3 px-4 w-full inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-violet-600 text-violet-600 hover:border-violet-500 hover:text-violet-500 focus:outline-hidden focus:border-violet-500 focus:text-violet-500 disabled:opacity-50 disabled:pointer-events-none dark:border-violet-500 dark:text-violet-500 dark:hover:text-violet-400 dark:hover:border-violet-400 dark:focus:text-violet-400 dark:focus:border-violet-400"
                                href="{{ route('checkout', ['plan' => 'price_1SLfBTLsxN8FK3ASfchPY4B7']) }}">
                                Sign UP
                            </a>
                        </div>
                        <!-- End Card -->
                ...
                <div
                    class="absolute top-1/2 start-1/2 -z-1 transform -translate-y-1/2 -translate-x-1/2 w-85 h-85 border border-dashed border-violet-200 rounded-full dark:border-violet-900/60">
                </div>
                <div
            ...
            <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
                ...
                <div class="hidden lg:block mt-6">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-1">
                            <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-violet-600 text-white hover:bg-violet-700 focus:outline-hidden focus:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
                                href="#">
                                Get started
                            </a>
                        </div>
        ...
        <div class="relative overflow-hidden">
            <div class="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto">
                ...
                <div aria-hidden="true" class="flex -z-1 absolute start-0">
                    <div class="bg-purple-200 opacity-20 blur-3xl w-[1036px] h-75 dark:bg-purple-900 dark:opacity-20">
                    </div>
                </div>
                <!-- End Gradients -->
